...
import { deleteX, updateDestination, updateUser } from '../API'
import { Navigate} from 'react-router-dom';

function AdminEditDestination({destination_data, parent_initializer}) {
    ...
    const [data, setData] = useState(destination_data)
