...
import { deleteX, updateRestaurant, updateUser } from '../API'
import { Navigate} from 'react-router-dom';

function AdminEditRestaurant({restaurant_data, parent_initializer}) {
    ...
    const [data, setData] = useState(restaurant_data)
